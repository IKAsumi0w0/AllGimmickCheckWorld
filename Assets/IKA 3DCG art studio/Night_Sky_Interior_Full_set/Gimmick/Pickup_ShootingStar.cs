...
public class Pickup_ShootingStar : UdonSharpBehaviour
{
    ...
    public void RandomShooting()
    {
        ...
        //初期化
        ShootingStar_Pickup ssmp = obj.transform.GetChild(0).GetComponent<ShootingStar_Pickup>();
    ...
    public void CheckStarFlg()
    {
        ...
        {
            ShootingStar_Pickup ssmp = _starObjArr[i].transform.GetChild(0).GetComponent<ShootingStar_Pickup>();
