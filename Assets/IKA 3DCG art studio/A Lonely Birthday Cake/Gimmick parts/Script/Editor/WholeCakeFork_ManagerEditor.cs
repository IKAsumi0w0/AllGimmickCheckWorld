...
[CustomEditor(typeof(WholeCakeFork_Manager))]
public class WholeCakeFork_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        WholeCakeFork_Manager script = (WholeCakeFork_Manager)target;

        // 複製する数を指定するスライダー
        numberOfCopies = EditorGUILayout.IntSlider("複製する数", numberOfCopies, 1, 50);
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            WholeCakeFork_PickupSub[] generatedObjects = new WholeCakeFork_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<WholeCakeFork_PickupSub>();
            }
