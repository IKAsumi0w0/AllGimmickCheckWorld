...
public class WholeCakeFork_Manager : UdonSharpBehaviour
{
    [HideInInspector] public WholeCakeFork_PickupSub[] _objs;
    ...
    public void SpawnObj()
    {
        ...
        {
            if (_objs[i]._main.DisplayFlg && _objs[i].transform.localPosition == Vector3.zero)
            {
                return;
            }
        }
