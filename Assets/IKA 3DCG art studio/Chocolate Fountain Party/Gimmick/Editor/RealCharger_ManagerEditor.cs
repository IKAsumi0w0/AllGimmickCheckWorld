...
[CustomEditor(typeof(RealCharger_Manager))]
public class RealCharger_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        RealCharger_Manager script = (RealCharger_Manager)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            RealCharger_PickupSub[] generatedObjects = new RealCharger_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<RealCharger_PickupSub>();
            }
