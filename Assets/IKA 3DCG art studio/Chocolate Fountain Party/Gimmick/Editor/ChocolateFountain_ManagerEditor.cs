...
[CustomEditor(typeof(ChocolateFountain_Manager))]
public class ChocolateFountain_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        ChocolateFountain_Manager script = (ChocolateFountain_Manager)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            ChocolateFountain_PickupSub[] generatedObjects = new ChocolateFountain_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<ChocolateFountain_PickupSub>();
            }
