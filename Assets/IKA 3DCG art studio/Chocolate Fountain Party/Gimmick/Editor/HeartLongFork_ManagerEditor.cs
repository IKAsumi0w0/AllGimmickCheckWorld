...
[CustomEditor(typeof(HeartLongFork_Manager))]
public class HeartLongFork_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        HeartLongFork_Manager script = (HeartLongFork_Manager)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            HeartLongFork_PickupSub[] generatedObjects = new HeartLongFork_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<HeartLongFork_PickupSub>();
            }
