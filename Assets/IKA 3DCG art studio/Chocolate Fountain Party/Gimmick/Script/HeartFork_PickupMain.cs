...
public class HeartFork_PickupMain : UdonSharpBehaviour
{
    public HeartFork_PickupSub _sub;
    ...
    [SerializeField] AudioSource _eatAS;
        ...
        set
        {
            ...
            else
            {
                ...
                for (int i = 0; i < splitValue.Length; i++)
                {
                    ...
                    tmpObj1.transform.localPosition = new Vector3(0, 0, 0);
    ...
    void Update()
    {
        //DebugTxt = $"PointedFood:{PointedFood}\nHeightFlg:{HeightFlg}\nChocoFlg:{ChocoFlg}\nAddChocoFlg:{AddChocoFlg}\nAddChocoValue:{AddChocoValue}";
    ...
    public void MainPickupUseDown()
    {
        ...
        if (0 < splitText0.Length)
        {
            ...
            PointedFood = t;
            SendCustomNetworkEvent(VRC.Udon.Common.Interfaces.NetworkEventTarget.All, nameof(PlayEatSE));
            RequestSerialization();
        }
    }
