...
[CustomEditor(typeof(IKA_WoodenSticks))]
public class IKA_WoodenSticksEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        IKA_WoodenSticks script = (IKA_WoodenSticks)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            WoodenStickMain[] generatedObjects = new WoodenStickMain[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<WoodenStickMain>();
            }
