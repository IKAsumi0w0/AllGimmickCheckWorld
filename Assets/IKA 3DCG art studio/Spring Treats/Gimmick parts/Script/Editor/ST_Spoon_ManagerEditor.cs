...
[CustomEditor(typeof(ST_Spoon_Manager))]
public class ST_Spoon_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        ST_Spoon_Manager script = (ST_Spoon_Manager)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            ST_Spoon_PickupSub[] generatedObjects = new ST_Spoon_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<ST_Spoon_PickupSub>();
            }
