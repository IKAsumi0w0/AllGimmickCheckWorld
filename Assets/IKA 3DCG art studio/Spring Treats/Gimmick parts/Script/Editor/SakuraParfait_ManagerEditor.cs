...
[CustomEditor(typeof(SakuraParfait_Manager))]
public class SakuraParfait_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        SakuraParfait_Manager script = (SakuraParfait_Manager)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            SakuraParfait_PickupSub[] generatedObjects = new SakuraParfait_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<SakuraParfait_PickupSub>();
            }
