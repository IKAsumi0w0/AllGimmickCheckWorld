...
[CustomEditor(typeof(SpringTreats_SakuraJuice_Manager))]
public class SpringTreats_SakuraJuice_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        SpringTreats_SakuraJuice_Manager script = (SpringTreats_SakuraJuice_Manager)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            SakuraJuice_PickupSub[] generatedObjects = new SakuraJuice_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<SakuraJuice_PickupSub>();
            }
