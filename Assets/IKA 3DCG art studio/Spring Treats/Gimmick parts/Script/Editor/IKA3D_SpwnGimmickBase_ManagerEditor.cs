...
[CustomEditor(typeof(IKA3D_SpwnGimmickBase_Manager), true)]
[CanEditMultipleObjects]
public class IKA3D_SpwnGimmickBase_ManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        // スクリプトのターゲットを取得
        IKA3D_SpwnGimmickBase_Manager script = (IKA3D_SpwnGimmickBase_Manager)target;
        ...
        if (GUILayout.Button("オブジェクトを複製して割り当て"))
        {
            ...
            IKA3D_SpwnGimmickBase_PickupSub[] generatedObjects = new IKA3D_SpwnGimmickBase_PickupSub[numberOfCopies];
            ...
            for (int i = 0; i < numberOfCopies; i++)
            {
                ...
                generatedObjects[i] = clone.GetComponent<IKA3D_SpwnGimmickBase_PickupSub>();
            }
